...
public class AnswerFriendRequestCommandHandler : IHandlerWrapper<AnswerFriendRequestCommand, AnswerFriendRequestResponse>
{
    ...
    public AnswerFriendRequestCommandHandler(IFriendsRequestsRepository requestRepository, IFriendsRepository friendRepository, ICurrentUserService userService)
    {
